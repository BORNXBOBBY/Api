...
export default function MovieDetails() {
  ...
  const handleData = async () => {
    var response = await fetch(
      `https://api.themoviedb.org/3/tv/${id}?api_key=35cd65256ea8eaefd87a8126fe806386&language=en-US`
    );
...
- #MOVIE DETAIL
*/}
  <section style={{background:`url(https://image.tmdb.org/t/p/original${tv.poster_path})`,
  ...
  height: "795px"
    ...
    <div className="container">
      <figure className="movie-detail-banner">
        <img style={{width:"100%", height:"400px"}} src={`https://image.tmdb.org/t/p/original${tv.backdrop_path}`} alt="Free guy movie poster" />
      ...
      <div className="movie-detail-content">
        ...
        <div className="meta-wrapper">
          ...
          <div className="date-time">
            <div>
            <i style={{color:"yellow"}} class="fas fa-calendar-week"></i>
...
<div className="footer-bottom">
  <div className="container">
    ...
    <img src="images/footer-bottom-img.png" alt="Online banking companies logo" className="footer-bottom-img" />
  </div>
</div>
</footer>
</>
